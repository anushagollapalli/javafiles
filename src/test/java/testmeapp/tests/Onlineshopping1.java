	  ...
	  public void testRegistration() throws Exception 
       {
		 ...
		 driver.findElement(By .name("userName")).sendKeys("anusha123aa");
		 ...
		 a.sendKeys(Keys.TAB).perform();
		 driver.findElement(By .name("firstName")).sendKeys("123gollapalli");
		 driver.findElement(By .name("lastName")).sendKeys("anusri");
		 driver.findElement(By .name("password")).sendKeys("passkey1234");
		 driver.findElement(By .name("confirmPassword")).sendKeys("passkey1234");
    ...
    public void testPayment() throws Exception
     {
	   ...
	   String actual="Your order has been confirmed";
	   Assert.assertEquals(expected,actual);
	   logger.log(Status.PASS,MarkupHelper.createLabel("Testpayment is passed",ExtentColor.GREEN)); 
	 }
